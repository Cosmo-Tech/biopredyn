 ...
 * 1. wraps std::cout
 *
 *    xos = LibSEDML::XMLOutputStream.new(LibSEDML::cout)
 *
 * 2. wraps std::cerr
 *
 ...
 *
 *    oss = LibSEDML::Ostringstream.new()
 *    xos = LibSEDML::XMLOutputStream.new(oss)
 *    ...
 *    LibSEDML::endl(oss)
 *    s = oss.str();
 * 
 ...
 */
%apply SWIGTYPE *DISOWN {SedBase* item};
%apply SWIGTYPE * {const SedBase* item};
