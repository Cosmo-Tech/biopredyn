 ...
 * @if clike libsbmlcs.libsbml.formulaToString()@endif@if csharp libsbmlcs.libsbml.formulaToString()@endif@if python libsbml.formulaToString()@endif@if java <c><a href='libsbml.html#formulaToString(org.sbml.libsbml.ASTNode)'>libsbml.formulaToString(ASTNode tree)</a></c>@endif@~
 * and read by @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></c>@endif@~
 * and
 * @if clike SBML_parseL3Formula()@endif@if csharp SBML_parseL3Formula()@endif@if python libsbml.parseL3Formula()@endif@if java <c><a href='libsbml.html#parseL3Formula(java.lang.String)'>libsbml.parseL3Formula(String formula)</a></c>@endif@~
 ...
 * @endif@~
 * @if java @see <c><a href='libsbml.html#formulaToString(org.sbml.libsbml.ASTNode tree)'>libsbml.formulaToString(ASTNode tree)</a></c>
 * @see <c><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, L3ParserSettings settings)</a></c>
 * @see <c><a href='libsbml.html#parseL3Formula(java.lang.String)'>libsbml.parseL3Formula(String formula)</a></c>
 * @see <c><a href='libsbml.html#parseL3FormulaWithModel(java.lang.String, org.sbml.libsbml.Model)'>parseL3FormulaWithModel(String formula, Model model)</a></c>
 * @see <c><a href='libsbml.html#getLastParseL3Error()'>getLastParseL3Error()</a></c>
 * @see <c><a href='libsbml.html#getDefaultL3ParserSettings()'>getDefaultL3ParserSettings()</a></c>
 * @endif@~
 */ public
 ...
 * are expanded versions of the formats produced and read by @if clike libsbmlcs.libsbml.formulaToString()@endif@if csharp libsbmlcs.libsbml.formulaToString()@endif@if python libsbml.formulaToString()@endif@if java <c><a href='libsbml.html#formulaToString(org.sbml.libsbml.ASTNode)'>libsbml.formulaToString(ASTNode tree)</a></c>@endif@~
 * and
 * @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></c>@endif@~, 
 ...
 * this function, compared to what is supported by  @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></c>@endif@~:
 *
 ...
 * parser implemented by @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></c>@endif@~
 ...
 * &quot;<c>(3 / 4)</c>&quot; will be parsed into the MathML
 * <c>&lt;divide&gt;</c> construct rather than a rational number.  The 
 * general number syntax allows you to assign units to a rational number, e.g.,
 * &quot;<c>(3/4) ml</c>&quot;.  (If the string is a division, units
 ...
 * @if clike SBML_parseL3FormulaWithSettings()@endif@if csharp SBML_parseL3FormulaWithSettings()@endif@if python libsbml.parseL3FormulaWithSettings()@endif@if java <c><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, L3ParserSettings settings)</a></c>@endif@~, including the following:
 * <ul>
 * <li> The function @c log with a single argument (&quot;<c>log(x)</c>&quot;) 
 * can be parsed as <c>log10(x)</c>, <c>ln(x)</c>, or treated
 * as an error, as desired.
 * <li> Unary minus signs can be collapsed or preserved; that is,
 * sequential pairs of unary minuses (e.g., &quot;<c>- -3</c>&quot;)
 ...
 * &quot;<c>pi</c>&quot;, and the formula to be parsed is
 * &quot;<c>3*pi</c>&quot;, the MathML produced will contain the
 * construct <c>&lt;ci&gt; pi &lt;/ci&gt;</c> instead of the
 * construct <c>&lt;pi/&gt;</c>.
 ...
 * &quot;<c>sin</c>&quot;, that function will be used instead of the
 * predefined MathML function <c>&lt;sin/&gt;</c>.
 * </ul>
 * These configuration settings cannot be changed using @em this function
 * (i.e., @if clike SBML_parseL3Formula()@endif@if csharp SBML_parseL3Formula()@endif@if python libsbml.parseL3Formula()@endif@if java <c><a href='libsbml.html#parseL3Formula(java.lang.String)'>libsbml.parseL3Formula(String formula)</a></c>@endif@~), 
 ...
 * @if clike SBML_getLastParseL3Error()@endif@if csharp SBML_getLastParseL3Error()@endif@if python libsbml.getLastParseL3Error()@endif@if java <c><a href='libsbml.html#getLastParseL3Error()'>libsbml.getLastParseL3Error()</a></c>@endif@~.
 *
 * Note that this facility and the SBML Level&nbsp;1-based @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></c>@endif@~
 ...
 * two arguments.  The values in the <b>Precedence</b> column show how the
 * order of different types of operation are determined.  For example, the
 * expression <c>a + b * c</c> is evaluated as <c>a + (b * c)</c> 
 ...
 * &quot;<c>log</c>&quot; as a function with a single argument can be
 ...
 * @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></c>@endif@~, 
 * the string &quot;<c>log</c>&quot; is interpreted as the base&nbsp;10
 ...
 * 
 * Note that whether the string &quot;<c>avogadro</c>&quot; is parsed
 * as an AST node of type @link libsbmlcs.libsbml.AST_NAME_AVOGADRO
 * AST_NAME_AVOGADRO@endlink or @link libsbmlcs.libsbml.AST_NAME
 ...
 * use @link libsbmlcs.libsbml.AST_NAME_AVOGADRO AST_NAME_AVOGADRO@endlink AST nodes.
 *
 * @param formula the text-string formula expression to be parsed
 *
 ...
 * the function @if clike SBML_parseL3Formula()@endif@if csharp SBML_parseL3Formula()@endif@if python libsbml.parseL3Formula()@endif@if java <c><a href='libsbml.html#parseL3Formula(java.lang.String)'>libsbml.parseL3Formula(String formula)</a></c>@endif@~.
 *
...
/**
 * Returns a copy of the default parser settings used by @if clike SBML_parseL3Formula()@endif@if csharp SBML_parseL3Formula()@endif@if python libsbml.parseL3Formula()@endif@if java <c><a href='libsbml.html#parseL3Formula(java.lang.String)'>libsbml.parseL3Formula(String formula)</a></c>@endif@~.
 * 
 ...
 *
 * If @if clike SBML_parseL3Formula()@endif@if csharp SBML_parseL3Formula()@endif@if python libsbml.parseL3Formula()@endif@if java <c><a href='libsbml.html#parseL3Formula(java.lang.String)'>libsbml.parseL3Formula(String formula)</a></c>@endif@~, 
 * @if clike SBML_parseL3FormulaWithSettings()@endif@if csharp SBML_parseL3FormulaWithSettings()@endif@if python libsbml.parseL3FormulaWithSettings()@endif@if java <c><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, L3ParserSettings settings)</a></c>@endif@~, or
 * @if clike SBML_parseL3FormulaWithModel()@endif@if csharp SBML_parseL3FormulaWithModel()@endif@if python libsbml.parseL3FormulaWithModel()@endif@if java <c><a href='libsbml.html#parseL3FormulaWithModel(java.lang.String, org.sbml.libsbml.Model)'>libsbml.parseL3FormulaWithModel(String formula, Model model)</a></c>@endif@~ return @c null, an error is set internally which is accessible
 * via this function. 
 *
 ...
 */ public
 static string getLastParseL3Error() {
  ...
  public const string LIBSBML_DOTTED_VERSION = "5.8.0";
  public const int LIBSBML_VERSION = 50800;
  public const string LIBSBML_VERSION_STRING = "50800";
