...
/**
   ...
   *
   * This works by adding a <c>xmlns=&quot;...&quot;</c> attribute.  No
...
/**
   * Sets the <c>required</c> attribute value of the given package
   * extension.
   *
...
/**
   * Returns the <c>required</c> attribute of the given package
   * extension.
   *
   * @note The name of package must not be given if the package is not
   * enabled.
...
/**
   * Sets the value of the <c>required</c> attribute for the given
   * package.
   *
   * @note The name of package must not be given if the package is not
   * enabled.
