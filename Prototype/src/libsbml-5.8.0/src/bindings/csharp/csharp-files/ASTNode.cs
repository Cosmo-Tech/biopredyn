 ...
 * 
 * The text-string form of mathematical formulas produced by @if clike libsbmlcs.libsbml.formulaToString()@endif@if csharp libsbmlcs.libsbml.formulaToString()@endif@if python libsbml.formulaToString()@endif@if java <c><a href='libsbml.html#formulaToString(org.sbml.libsbml.ASTNode)'>libsbml.formulaToString()</a></c>@endif@~ and
 * read by @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></c>@endif@~
 * and
 ...
 * @if java @see <c><a href='libsbml.html#parseL3Formula(String formula)'>libsbml.parseL3Formula(String formula)</a></c>@endif@~
 ...
 * @if java @see <c><a href='libsbml.html#parseFormula(String formula)'>libsbml.parseFormula(String formula)</a></c>@endif@~
 */
