 ...
 * @if clike libsbmlcs.libsbml.parseFormula()@endif@if csharp libsbmlcs.libsbml.parseFormula()@endif@if python libsbml.parseFormula()@endif@if java <c><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(java.lang.String formula)</a></c>@endif@~
 * and
 * @if clike SBML_parseL3FormulaWithModel()@endif@if csharp SBML_parseL3FormulaWithModel()@endif@if python libsbml.parseL3FormulaWithModel()@endif@if java <c><a href='libsbml.html#parseL3FormulaWithModel(java.lang.String, org.sbml.libsbml.Model)'>libsbml.parseL3FormulaWithModel(String formula, Model model)</a></c>@endif@~,
 ...
 * @if clike SBML_parseL3FormulaWithSettings()@endif@if csharp SBML_parseL3FormulaWithSettings()@endif@if python libsbml.parseL3FormulaWithSettings()@endif@if java <c><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, org.sbml.libsbml.L3ParserSettings settings)</a></c>@endif@~.
 ...
 * @if clike SBML_getDefaultL3ParserSettings()@endif@if csharp SBML_getDefaultL3ParserSettings()@endif@if python libsbml.SBML_getDefaultL3ParserSettings()@endif@if java <c><a href='libsbml.html#getDefaultL3ParserSettings()'>libsbml.getDefaultL3ParserSettings()</a></c>@endif@~.
 ...
 * @endif@~
 * @if java @see <c><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, L3ParserSettings settings)</a></c>
...
/**
   ...
   * (&quot;<c>log(x)</c>&quot;) can be parsed as
   * <c>log10(x)</c>, <c>ln(x)</c>, or treated as an error, as
   * desired.
   *
...
/**
   ...
   * minuses in a row (e.g., &quot;<c>- -3</c>&quot;) can be
   ...
   * number node itself; for example, a &quot;<c>- 4.1</c>&quot; can
   * be turned into a single ASTNode of type @link libsbmlcs.libsbml.AST_REAL
   * AST_REAL@endlink with a value of <c>-4.1</c>, or it can be
...
/**
   ...
   * <c>&lt;cn&gt;</c> elements can have an attribute named @c units
   ...
   * include: &quot;<c>4 mL</c>&quot;, &quot;<c>2.01
   * Hz</c>&quot;, &quot;<c>3.1e-6 M</c>&quot;, and
   * &quot;<c>(5/8) inches</c>&quot;.  To produce a valid SBML model,
