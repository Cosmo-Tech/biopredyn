...
/**
 ...
 static void disablePackages(SWIGTYPE_p_std__vectorT_std__string_t packages) {
    libsbmlPINVOKE.SBMLExtensionRegistry_disablePackages(SWIGTYPE_p_std__vectorT_std__string_t.getCPtr(packages));
...
/**
 ...
 static void enablePackages(SWIGTYPE_p_std__vectorT_std__string_t packages) {
    libsbmlPINVOKE.SBMLExtensionRegistry_enablePackages(SWIGTYPE_p_std__vectorT_std__string_t.getCPtr(packages));
    if (libsbmlPINVOKE.SWIGPendingException.Pending) throw libsbmlPINVOKE.SWIGPendingException.Retrieve();
  }
