 ...
 * @if clike RDFAnnotationParser::parseRDFAnnotation(XMLNode annotation, %List CVTerms)
 * @endif@if java RDFAnnotationParser::parseRDFAnnotation(XMLNode annotation, %CVTermList CVTerms) @endif@~
...
/**
   ...
   */ public
 static void parseRDFAnnotation(XMLNode annotation, SWIGTYPE_p_List CVTerms, string metaId, XMLInputStream stream) {
    libsbmlPINVOKE.RDFAnnotationParser_parseRDFAnnotation__SWIG_0(XMLNode.getCPtr(annotation), SWIGTYPE_p_List.getCPtr(CVTerms), metaId, XMLInputStream.getCPtr(stream));
  }
...
/**
   ...
   * @see @if clike parseRDFAnnotation(XMLNode annotation) @else RDFAnnotationParser::parseRDFAnnotation(XMLNode annotation) @endif@~
   */ public
 static void parseRDFAnnotation(XMLNode annotation, SWIGTYPE_p_List CVTerms, string metaId) {
    libsbmlPINVOKE.RDFAnnotationParser_parseRDFAnnotation__SWIG_1(XMLNode.getCPtr(annotation), SWIGTYPE_p_List.getCPtr(CVTerms), metaId);
  }
...
/**
 ...
 static ModelHistory parseRDFAnnotation(XMLNode annotation, string metaId, XMLInputStream stream) {
    IntPtr cPtr = libsbmlPINVOKE.RDFAnnotationParser_parseRDFAnnotation__SWIG_2(XMLNode.getCPtr(annotation), metaId, XMLInputStream.getCPtr(stream));
...
/**
 ...
 static ModelHistory parseRDFAnnotation(XMLNode annotation, string metaId) {
    IntPtr cPtr = libsbmlPINVOKE.RDFAnnotationParser_parseRDFAnnotation__SWIG_3(XMLNode.getCPtr(annotation), metaId);
    ModelHistory ret = (cPtr == IntPtr.Zero) ? null : new ModelHistory(cPtr, false);
    return ret;
  }
...
/**
 ...
 static ModelHistory parseRDFAnnotation(XMLNode annotation) {
    IntPtr cPtr = libsbmlPINVOKE.RDFAnnotationParser_parseRDFAnnotation__SWIG_4(XMLNode.getCPtr(annotation));
    ModelHistory ret = (cPtr == IntPtr.Zero) ? null : new ModelHistory(cPtr, false);
    return ret;
  }
...
/**
   ...
   * an SBML <c>&lt;annotation&gt;</c> element.
   *
   * @param obj the SBML object to start from
   *
...
/**
 ...
 static XMLNode deleteRDFCVTermAnnotation(XMLNode annotation) {
  ...
  public static void parseRDFAnnotation(XMLNode annotation, CVTermList CVTerms) {
    libsbmlPINVOKE.RDFAnnotationParser_parseRDFAnnotation__SWIG_5(XMLNode.getCPtr(annotation), CVTermList.getCPtr(CVTerms));
  }
