...
/**
   * Returns the first child element found that has the given <code>id</code> in the model-wide SId namespace, or <code>null</code> if no such object is found.  Note that UnitDefinitions themselves are in the UnitId namespace, not the SId namespace, so no {@link UnitDefinition} object will be returned from this function (and is the reason we override the base ListOf.getElementBySId function here).
   * <p>
