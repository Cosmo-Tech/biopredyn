...
/**
   * Returns the first child element found that has the given <code>id</code> in the model-wide SId namespace, or <code>null</code> if no such object is found.  Note that InitialAssignments do not actually have IDs, though the {@link libsbml} interface pretends that they do:  no initial assignment is returned by this function.
   * <p>
