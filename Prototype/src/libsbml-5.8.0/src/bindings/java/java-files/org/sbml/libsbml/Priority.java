...
/**
   ...
   * the document <em>overrides</em> the value used when creating the {@link Priority}
   * object via this constructor.  This is necessary to ensure that an SBML
   * document is a consistent structure.  Nevertheless, the ability to
   * supply the values at the time of creation of a {@link Priority} is an important
   * aid to producing valid SBML.  Knowledge of the intented SBML Level and
   * Version determine whether it is valid to assign a particular value to
   * an attribute, or whether it is valid to add a particular {@link Priority} object
...
/**
   ...
   * all the required elements for this {@link Priority} object
   * have been set.
   * <p>
...
/**
   * Finds this {@link Priority}'s {@link Event} parent and calls unsetPriority() on it, indirectly deleting itself.  Overridden from the {@link SBase} function since the parent is not a {@link ListOf}.
   * <p>
   * @return integer value indicating success/failure of the
   * function.   The possible values
   * returned by this function are:
