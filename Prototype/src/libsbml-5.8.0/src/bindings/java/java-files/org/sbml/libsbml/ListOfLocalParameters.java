...
/**
   * Returns the first child element found that has the given <code>id</code> in the model-wide SId namespace, or <code>null</code> if no such object is found.  Note that LocalParameters, while they use the SId namespace, are not in the model-wide SId namespace, so no {@link LocalParameter} object will be returned from this function (and is the reason we override the base ListOf.getElementBySId function here).
   * <p>
