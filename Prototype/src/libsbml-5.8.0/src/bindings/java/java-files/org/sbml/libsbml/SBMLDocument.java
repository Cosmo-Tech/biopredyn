...
/**
   ...
   * Level available at the time libSBML version 5.8.0
...
/**
   * Returns the first child element it can find with the given <code>metaid</code>, or itself if it has the given <code>metaid</code>, or <code>null</code> if no such object is found.
   * <p>
