...
{@link GroupsExtension#init()}
{
  ...
  //    {@link SBMLDocumentPluginNotRequired} class can be used as-is for the plugin.
  //
  ...
  {@link SBasePluginCreator}&lt;{@link SBMLDocumentPluginNotRequired}, GroupsExtension&gt; sbmldocPluginCreator(sbmldocExtPoint,packageURIs);
...
/** 
 ...
 SWIGTYPE_p_packageErrorTableEntry getErrorTable(long index) {
    return new SWIGTYPE_p_packageErrorTableEntry(libsbmlJNI.SBMLExtension_getErrorTable(swigCPtr, this, index), true);
  }
