 ...
 * are expanded versions of the formats produced and read by <code><a href='libsbml.html#formulaToString(org.sbml.libsbml.ASTNode)'>libsbml.formulaToString(ASTNode tree)</a></code>
 * and
 ...
 * this function, compared to what is supported by  <code><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></code>:
 * <p>
 * <ul>
 ...
 * is optional.
 * <li> The Boolean function symbols <code>&&</code>, <code>||</code>, <code>!</code>, and <code>!=</code> may be used.
 ...
 * either using <code>arc</code> as a prefix or simply <code>a</code>; in other words, both
 * <code>arccsc</code> and <code>acsc</code> are interpreted as the operator <em>arccosecant</em>
 * defined in MathML.  (Many functions in the SBML Level&nbsp;1 infix-notation
 * parser implemented by <code><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></code>
 ...
 * <li> Various settings may be altered by using an {@link L3ParserSettings} object
 * in conjunction with the alternative function call
 * <code><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, {@link L3ParserSettings} settings)</a></code>, including the following:
 * <ul>
 ...
 * </ul>
 * These configuration settings cannot be changed using <em>this</em> function
 * (i.e., <code><a href='libsbml.html#parseL3Formula(java.lang.String)'>libsbml.parseL3Formula(String formula)</a></code>), 
 ...
 * this function will return <code>null</code> instead.  When <code>null</code> is returned, an
 ...
 * <p>
 * Note that this facility and the SBML Level&nbsp;1-based <code><a href='libsbml.html#parseFormula(java.lang.String)'>libsbml.parseFormula(String formula)</a></code>
...
<tr><td><em>name</em></td><td>symbol reference</td><td>operand</td><td align='center'>10</td><td>n/a</td></tr>
<tr><td><code>(</code><em>expression</em><code>)</code></td><td>expression grouping</td><td>operand</td><td align='center'>10</td><td>n/a</td></tr>
<tr><td><code>f(</code><em>...</em><code>)</code></td><td>function call</td><td>prefix</td><td align='center'>9</td><td>left</td></tr>
<tr><td><code>-</code></td><td>negation</td><td>unary</td><td align='center'>8</td><td>right</td></tr>
<tr><td><code>^</code></td><td>power</td><td>binary</td><td align='center'>7</td><td>left</td></tr>
<tr><td><code>*, /, %</code></td><td>multiplication, division, and modulo</td><td>binary</td><td align='center'>6</td><td>left</td></tr>
<tr><td><code>+, -</code></td><td>addition and subtraction</td><td>binary</td><td align='center'>5</td><td>left</td></tr>
<tr><td><code>!</code></td><td>boolean 'not'</td><td>unary</td><td align='center'>4</td><td>right</td></tr>
 ...
 * changed; use the function <code><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, {@link L3ParserSettings} settings)</a></code>
 * instead of this function and pass it an appropriate {@link L3ParserSettings}
 ...
 * AST_NAME_AVOGADRO} or {@link  libsbmlConstants#AST_NAME
 * AST_NAME} is configurable; use the alternate version of this
 * function, called
 * <code><a href='libsbml.html#parseL3FormulaWithSettings(java.lang.String, org.sbml.libsbml.L3ParserSettings)'>libsbml.parseL3FormulaWithSettings(String formula, {@link L3ParserSettings} settings)</a></code>.
 * This functionality is provided because SBML Level&nbsp;2 models may not
 * use {@link  libsbmlConstants#AST_NAME_AVOGADRO AST_NAME_AVOGADRO} AST nodes.
 * <p>
 * @param formula the text-string formula expression to be parsed
 * <p>
